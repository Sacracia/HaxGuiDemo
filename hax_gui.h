...
namespace Hax::Gui
{
    ...
    enum class FontHandle : size_t {};
    enum class MsdfFontHandle : size_t {};
...
namespace Hax::Gui
{
    ...
    struct  RectParams      { Color BorderColor = Color::Transparent; float BorderTh = 0.f; Color FillColor; Vector4 Rounding; };
    struct  EllipseParams   { Color BorderColor; float BorderTh; Color FillColor; };
    struct  TriangleParams  { Color BorderColor; float BorderTh; Color FillColor; };
    struct  LineParams      { Color FillColor = Color::Black; float Th = 1_px; };
    struct  ImageParams     { Color BgColor = Color::White; float R = 0.f; Vector2 UVmin = {}; Vector2 UVmax = { 1.f, 1.f }; };
    struct  MsdfGlyphParams { Color Color = Color::Black; bool Outline = false; Hax::Gui::Color OutCol = Color::Black; float Spacing = 1.f; float Weight = 0.f; };
    ...
    struct StringEditParams { Color CaretColor = Color::Black; WStringView Hint = {}; Color HintColor = 0x969fafff; Color TextColor = Color::Black; };
    ...
    struct FontMetrics { float Ascent, CapHeight, Descent, LineHeight; };
...
namespace Hax::Gui
{
    ...
    struct IBackend
    {
        ...
        virtual Texture2DArray CreateAtlasArray(int width, int height, int depth) = 0;
        virtual void SetSubarray(Texture2DArray array, int depth, int w, int h, const uint8* data) = 0;
        ...
        virtual void UpdateTextureRect(Texture2D tex, const uint8* pixels, const RectU& rect) = 0;
